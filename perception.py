...
class Percept:
  ...
  def json(self, indent=None):
    """
    Returns a JSON version of this percept.
    """
    return json.dumps(
      {
        "type": "Percept",
  ...
  def from_json(jin):
    """
    Creates a Percept from a JSON object. This method handles Percept,
    Prospective, and Retrospective types. Examples:
    ```
    {
      "type": "Percept",
    }
    ...
    if obj["type"] == "Percept":
      ...
      return Retrospective(
        ...
        obj["valence"],
        obj["salience"],
        # TODO: HERE Use from_obj / obj() instead of from_json/json
        prospective=Percept.from_json(obj["prospective"])
      )
...
class Retrospective(Percept):
  ...
  def merge_retrospective_impressions(ilist):
    ...
    and merges them into a single abstract impression of that goal, which
    includes an abstract prospective impression as well.
    """
